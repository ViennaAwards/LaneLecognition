...
int main(int argc, char** argv)
{
	...
	cameraMatrix = (Mat1d(3, 3) << 164.102, 0., 156.574, 0., 163.753, 127.167, 0., 0., 1.);
  ...
  //VideoCapture cap("/home/cseecar/catkin_ws/video/clockwise.mp4");
	...
	for (;;) {
		...
		if (capture) {
			...
			if (frame.empty())
				break;
			distCoeffs = (Mat1d(1, 4) << -0.275899, 0.065336, -0.003015, -0.000803);
			//undistort(frame, ust, cameraMatrix, distCoeffs);
